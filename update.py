...
print(f'Fetch signature 1 : {url1}.sig ', requests.get(f'{url1}.sig').text)
print(f'Fetch signature 2 : {url2}.sig ', requests.get(f'{url2}.sig').text)
print(f'Fetch signature 3 : {url3}.sig ', requests.get(f'{url3}.sig').text)
print(f'Fetch signature 4 : {url4}.sig ', requests.get(f'{url4}.sig').text)
data = {
    'files': {
        'update.json': {
            'content': json.dumps({
